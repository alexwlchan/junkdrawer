...
@pytest.mark.parametrize(
    "description, expected",
    [
        ("It's a fox, jumping over the dog", "It's a fox, jumping over the dog"),
        ("It’s a fox, jumping over the dog", "It’s a fox, jumping over the dog"),
        ("ItÕs a fox, jumping over the dog", "It’s a fox, jumping over the dog"),
    ],
)
def test_fix_encoding(description, expected):
    assert fix_encoding(description) == expected
