# These autocompletions are taken from a prior version of fish, so tab completion
# actually works for files again.  It's copied straight out of the completions file,
# because I CBA to debug this properly.
